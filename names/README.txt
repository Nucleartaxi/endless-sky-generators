...
Later I will run these star names through the language mixer to get more variety as well. 
...
planet names 3 uses the 3 melodic alphabet conversions combined.

planet names 4 uses the 2 sibilant alphabet conversions combined.

planet names 5 uses the 2 standard alphabet conversions combined.

planet names 6 uses the Cthulu alphabet conversion 

planet names 7 uses the Xanth alphabet conversion
